                            ...
                            <div class="q-mt-sm q-pa-xs">
                              ...
                              <div class="q-mt-sm q-pa-xs">
                                <q-input
                                    ...
                                    dense="dense">
                                    <template v-slot:prepend>
                                    <q-icon name="far fa-envelope" class="cursor-pointer"></q-icon>
                                    </template>
                                </q-input>
                            </div>
                            <div class="q-mt-sm q-pa-xs">
        ...
        this
          ...
          .then(() => {
            this
              .$q
              .notify(
                { icon: 'done', message: 'Register Success', color: 'green', textColor: 'white', timeout: 3000 }
              )
            this
              .$router
              .push('/login')
            ...
            if (error.response) {
              if (error.response.status === 401) {
                ...
                this
                  .$q
                  .notify(
                    { icon: 'announcement', color: 'red', textColor: 'white', timeout: 3000, message: 'not found!' }
                  )
              } else {
              }
            }
